# Hotspot-Analysis-On-NYC-Taxi-DataSet
Project spatial hot spot analysis on NYC Taxi Dataset

## Requirement

In this phase, you are required to do spatial hot spot analysis on NYC Taxi Dataset. In particular, you need to complete two different hot spot analysis tasks 
